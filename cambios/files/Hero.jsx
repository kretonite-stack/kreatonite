...
export default function Hero() {
  const [phase, setPhase] = useState("black"); // black → flash → reveal → full
  const [mousePos, setMousePos] = useState({ x: 0, y: 0 });
  const heroRef = useRef(null);

  useEffect(() => {
    // Secuencia cinemática de entrada
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "#aaff00",
          opacity: phase === "flash" ? 0.7 : 0,
          transition: phase === "flash" ? "opacity 0.15s ease-in" : "opacity 0.6s ease-out",
        }}
      />

      {/* ── SEGUNDA PULSACIÓN DE ENERGÍA ── */}
      <div
        className="absolute inset-0 pointer-events-none z-40"
        style={{
          background: "radial-gradient(ellipse at 65% 50%, rgba(170,255,0,0.35) 0%, transparent 60%)",
      ...
      {/* ── ESCENA 3D (ocupa todo el canvas) ── */}
      <div className="absolute inset-0 z-20">
        <Scene3D phase={phase} mousePos={mousePos} />
      </div>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.75) 38%, rgba(0,0,0,0.2) 60%, transparent 75%)",
        }}
      />
        ...
        <div style={{ maxWidth: 560 }}>
          ...
          <h1
            style={{
              ...
              color: "#aaff00",
              textShadow:
                "0 0 50px rgba(170,255,0,0.8), 0 0 100px rgba(170,255,0,0.4), 0 0 160px rgba(170,255,0,0.2)",
          ...
          >
            <button
              ...
              onMouseDown={(e) => { e.currentTarget.style.transform = "scale(0.95)"; e.currentTarget.style.boxShadow = "0 0 60px #aaff00"; }}
              onMouseUp={(e) => { e.currentTarget.style.transform = "scale(1.04)"; e.currentTarget.style.boxShadow = "none"; }}
            >
              ⚡ COMPRAR AHORA
            </button>
            <button
        ...
        {[
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: 9, letterSpacing: 2, color: "rgba(255,255,255,0.4)" }}>
                {f.sub}
              </div>
            </div>
          </div>
      ...
      <style>{`
        ...
        @keyframes titleGlow {
          from { text-shadow: 0 0 40px rgba(170,255,0,.6), 0 0 80px rgba(170,255,0,.2); }
          to   { text-shadow: 0 0 70px rgba(170,255,0,1), 0 0 130px rgba(170,255,0,.6), 0 0 200px rgba(170,255,0,.2); }
        }
        @keyframes btnPulse {
